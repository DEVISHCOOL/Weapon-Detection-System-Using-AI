...
Usage:
  ...
  # Create train data:
  python generate_TFR.py --csv_input=data/gun_train3.csv  --output_path=data/gun_train3.record
  # Create test data:
  python generate_TFR.py --csv_input=data/gun_test3.csv  --output_path=data/gun_test3.record
"""
